  ...
  this.drehen = function() {
    ...
    if (this.senkrecht) {
      ...
      if (this.x > 1) {
        ...
        if (graphics.gridArray[round(this.y + 1)][this.x - 2] == 0 && graphics.gridArray[round(this.y + 2)][this.x] == 0) {
    ...
    //Wenn es quer liegt wird es senkrecht gedreht
      ...
      if (round(this.y) > 0 && round(this.y) < graphics.bloeckeProSpalte - 2) {
        //Wieder wird erst mal geprueft, ob ausreichend Platz vorhanden ist
        if (graphics.gridArray[round(this.y)][this.x + 2] == 0 && graphics.gridArray[round(this.y - 1)][this.x + 2] == 0 && graphics.gridArray[round(this.y + 2)][this.x + 1] == 0) {
  ...
  this.freierFall = function() {
    ...
    for (var i = floor(this.y); i < graphics.bloeckeProSpalte; i++) {
      ...
      //Wenn der Stein quer liegt
        ...
        if (graphics.gridArray[i][this.x + 1] < 0 || graphics.gridArray[i][this.x + 2] < 0) {
  ...
  this.bewegungRechts = function() {
    ...
    if (this.senkrecht) {
      ...
      if (this.x < graphics.bloeckeProZeile - 1) {
        ...
        if (!(graphics.gridArray[round(this.y)][this.x + 1] < 0) && !(graphics.gridArray[round(this.y + 1)][this.x + 1] < 0) && !(graphics.gridArray[round(this.y + 2)][this.x] < 0)) {
    ...
    //Wenn der Stein quer liegt
      ...
      if (this.x < graphics.bloeckeProZeile - this.breite) {
        //Dann pruefen, ob ein Hindernis im Weg ist
        if (!(graphics.gridArray[round(this.y)][this.x + 2] < 0) && !(graphics.gridArray[round(this.y + 1)][this.x + this.breite] < 0)) {
